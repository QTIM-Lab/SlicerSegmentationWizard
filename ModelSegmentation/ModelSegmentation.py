...
# import urllib
# downloads = (
#     ('http://slicer.kitware.com/midas3/download?items=8986', 'TestModel.vtk', slicer.util.loadScene),
#     )
...
while modelsegmentation_module.Step2._RegistrationStep__status != "Completed":
    pass
